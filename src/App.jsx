...
//           worker.postMessage({ initialPos, finalPos, startTime, currentTime });
//         }
...
//               const { intermediatePositions } = e.data;
//               gl.useProgram(programRef.current);
//               gl.bindBuffer(gl.ARRAY_BUFFER, positionBuffer);
//               gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(intermediatePositions), gl.STATIC_DRAW);
//               let positionAttributeLocation = gl.getAttribLocation(shaderProgram, "position");
...
//               const mvpMatrix = mat4.create();
//               let modelMatrix = mat4.create();
//               let timeFlow = (currentTime - startTime) / 3000;
//               let angle = (60 * timeFlow * Math.PI / 180);
//               mat4.rotateY(modelMatrix, modelMatrix, angle);
    
//               const fov = 70 * Math.PI / 180;
//               const canvasAspect = canvas.width / canvas.height;
//               const distanceToOrigin = 2;
//               const cameraPosition = [0, 0.65, distanceToOrigin];
//               const near = 0.1;
//               const far = 10000;
//               const projectionMatrix = mat4.create();
...
function App() {
    ...
    useEffect(() => {
        ...
        // Initialize Web Worker
        const worker = new Worker(new URL('./animationWorker.js', import.meta.url), { type: 'module' });
        ...
        worker.onmessage = function(e) {
            ...
            const mvpMatrix = mat4.create();
            let modelMatrix = mat4.create();
            let timeFlow = (e.data.currentTime - startTime) / 3000;
            let angle = (60 * timeFlow * Math.PI / 180);
            mat4.rotateY(modelMatrix, modelMatrix, angle);
